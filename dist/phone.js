...
exports.MARKET_COUNTRY_CODE = void 0;
exports.isEngineKey = isEngineKey;
exports.normalizeForEngine = normalizeForEngine;
exports.sameEngineKey = sameEngineKey;
/**
 ...
 */
function normalizeForEngine(raw, tenantCC) {
    if (typeof raw !== 'string')
        return null;
    if (!/^[1-9]\d{0,3}$/.test(tenantCC))
        return null;
